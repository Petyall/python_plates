...
#     # Шаг 1: Повышение/понижение яркости в зависимости от освещения
#     mean_brightness = cv2.mean(original_image)[0]

#     if mean_brightness > 127:
#         # Засвеченное изображение
#         processed_image = cv2.convertScaleAbs(original_image, alpha=1.3, beta=30)
#     else:
#         # Затемненное изображение
#         processed_image = cv2.convertScaleAbs(original_image, alpha=0.7, beta=30)

#     # Шаг 2: Адаптивное изменение контрастности
...
#     text = pytesseract.image_to_string(processed_image, lang='eng', config='--psm 10 -c tessedit_char_whitelist=ABEKkMmHOoPpCcTYyXx0123456789')
#     return text
